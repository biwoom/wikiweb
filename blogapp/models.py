...
def upload_path_img(instance, filename):
    return "blogapp/images/%s/%s" %(instance.id, filename)
    
def upload_path_file(instance, filename):
    return "blogapp/files/%s/%s" %(instance.id, filename)    
    
def upload_path_audio(instance, filename):
    return "blogapp/audio/%s/%s" %(instance.id, filename)     
    
class Blog_BW(models.Model):
