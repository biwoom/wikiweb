...
def upload_path_img(instance, filename):
    return "introapp/images/%s/%s" %(instance.id, filename)
    
def upload_path_file(instance, filename):
    return "introapp/files/%s/%s" %(instance.id, filename)    
    
def upload_path_audio(instance, filename):
    return "introapp/audio/%s/%s" %(instance.id, filename)     
    
class Intro_BW(models.Model):
