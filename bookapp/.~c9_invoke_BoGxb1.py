...
# 서지정보 파트 ==============================
    # 1. 출판일
    published_date = models.CharField(blank=True, null=True, default='', max_length=100, verbose_name='출판일', help_text='')
    # 2. 페이지수
    ...
    # 4. 개정일
    revised_date = models.CharField(blank=True, null=True, default='', max_length=100, verbose_name='개정일', help_text='')
    # 5. 판형
...
# 추가 정보 파트 ==============================
    ...
    # 2. 오탈자수정일
    errata_date = models.CharField(blank=True, null=True, default='', max_length=100, verbose_name='오탈자수정일', help_text='')
    # 3. 강의 동영상 유투브 URL
